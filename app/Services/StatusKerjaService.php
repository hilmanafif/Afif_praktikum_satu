...
class StatusKerjaService
{
     ...
     * Service Constructor
     *
     * @param StatusKerja $statuskerja
     */
    public function __construct(StatusKerja $statuskerja)
    {
        $this->model        = $statuskerja;
    ...
    public function search($payload)
    {
        ...
        $columns = Schema::getColumnListing('statuskerjas');
