...
class SubjabatanService
{
     ...
     * Service Constructor
     *
     * @param Subjabatan $subjabatan
     */
    public function __construct(Subjabatan $subjabatan)
    {
        $this->model        = $subjabatan;
    ...
    public function search($payload)
    {
        ...
        $columns = Schema::getColumnListing('subjabatans');
