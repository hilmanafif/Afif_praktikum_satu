...
class GolonganDarahService
{
     ...
     */
    public function __construct(GolonganDarah $golongandarah)
    {
        $this->model        = $golongandarah;
    ...
    public function search($payload)
    {
        ...
        $columns = Schema::getColumnListing('golongandarahs');
