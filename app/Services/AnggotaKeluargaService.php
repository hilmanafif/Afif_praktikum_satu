...
class AnggotaKeluargaService
{
     ...
     * Service Constructor
     *
     * @param AnggotaKeluarga $anggotakeluarga
     */
    public function __construct(AnggotaKeluarga $anggotakeluarga)
    {
        $this->model        = $anggotakeluarga;
    ...
    public function search($payload)
    {
        ...
        $columns = Schema::getColumnListing('anggotakeluargas');
