    ...
    public function generatePayroll(Request $request){
      ...
      //HARDCODED PAYROLL TYPE
        ...
        if ($payrolltype){
          ...
          $totalpotongan = $employee->potongan->bpjs + $employee->potongan->dapenma + $employee->potongan->bpjskes + $employee->potongan->zakat + $employee->potongan->bjb + $employee->potongan->iurandw + $employee->potongan->tabungan + $employee->potongan->warung + $employee->potongan->pinjrutin + $employee->potongan->pinjperum + $employee->potongan->utangpeg + $employee->potongan->potlain + $employee->potongan->iuranykpp;
          //$employee->potongan->bpjspensiun + 
