...
class RoleController extends Controller
{
    ...
    public function store(RoleCreateRequest $request)
    {
        ...
        if ($result) {
          ...
          Logsystem::create(['name' => 'is creating new Role', 'ipaddress' => $ipaddress, 'user_id' => $user_id ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($result) {
          $user_id = Auth::user()->id;
          $ipaddress = $request->ip();
          Logsystem::create(['name' => 'is updating Role', 'ipaddress' => $ipaddress, 'user_id' => $user_id ]);
    ...
    public function destroy($id)
    {
        ...
        if ($result) {
          $user_id = Auth::user()->id;
          $ipaddress = $request->ip();
          Logsystem::create(['name' => 'is deleting Role', 'ipaddress' => $ipaddress, 'user_id' => $user_id ]);
