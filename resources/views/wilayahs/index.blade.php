...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="pull-left">List Wilayah</h1>
        </div>
    </div>
                    ...
                    @foreach($wilayahs as $wilayah)
                        <tr>
                            ...
                            <td>
                                ...
                                <a style="margin-right:4px;" class="btn btn-warning btn-xs pull-right" href="{!! route('wilayahs.edit', [$wilayah->id]) !!}"><i class="fa fa-pencil"></i> Edit</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
