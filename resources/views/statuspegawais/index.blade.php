...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="pull-left">StatusPegawais</h1>
        </div>
    </div>
                    ...
                    @foreach($statuspegawais as $statuspegawai)
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-warning btn-xs" href="{!! route('statuspegawais.show', [$statuspegawai->id]) !!}"><i class="fa fa-search"></i> Show</a>
                                <a class="btn btn-warning btn-xs" href="{!! route('statuspegawais.edit', [$statuspegawai->id]) !!}"><i class="fa fa-pencil"></i> Edit</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
