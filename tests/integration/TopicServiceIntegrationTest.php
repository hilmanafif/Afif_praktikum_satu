...
class TopicServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(TopicService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => 'laravel',
		'description' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Topic');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('topics', $this->editedArray);
    }
