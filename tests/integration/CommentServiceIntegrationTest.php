...
class CommentServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(CommentService::class);
        $this->originalArray = [
            'id' => '1',
		'content_id' => 'laravel',
		'name' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Comment');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('comments', $this->editedArray);
    }
