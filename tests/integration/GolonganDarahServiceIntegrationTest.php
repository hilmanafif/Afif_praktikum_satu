...
class GolonganDarahServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(GolonganDarahService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\GolonganDarah');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('golongandarahs', $this->editedArray);
    }
