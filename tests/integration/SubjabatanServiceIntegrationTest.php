...
class SubjabatanServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(SubjabatanService::class);
        $this->originalArray = [
            'id' => '1',
		'jabatan_id' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Subjabatan');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('subjabatans', $this->editedArray);
    }
