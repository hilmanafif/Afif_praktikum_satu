...
class SkillServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(SkillService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => 'laravel',
		'description' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Skill');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('skills', $this->editedArray);
    }
