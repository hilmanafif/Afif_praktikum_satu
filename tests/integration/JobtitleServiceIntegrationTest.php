...
class JobtitleServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(JobtitleService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => 'laravel',
		'company_id' => '1',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Jobtitle');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('jobtitles', $this->editedArray);
    }
