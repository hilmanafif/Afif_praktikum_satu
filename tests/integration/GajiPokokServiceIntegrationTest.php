...
class GajiPokokServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(GajiPokokService::class);
        $this->originalArray = [
            'id' => '1',
		'id_pangkat' => 'laravel',
		'masa_kerja' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\GajiPokok');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('gajipokoks', $this->editedArray);
    }
