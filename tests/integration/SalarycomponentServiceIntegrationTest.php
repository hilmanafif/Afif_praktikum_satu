...
class SalarycomponentServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(SalarycomponentService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => 'laravel',
		'default' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Salarycomponent');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('salarycomponents', $this->editedArray);
    }
