...
class WilayahServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(WilayahService::class);
        $this->originalArray = [
            'id' => '1',
		'kode' => 'laravel',
		'name' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Wilayah');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('wilayahs', $this->editedArray);
    }
