...
class LogsystemServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(LogsystemService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => 'laravel',
		'ipaddress' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Logsystem');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('logsystems', $this->editedArray);
    }
