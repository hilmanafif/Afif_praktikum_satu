...
class DepartmentServiceIntegrationTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Department');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('departments', $this->editedArray);
    }
