...
class TimezoneServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(TimezoneService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => 'laravel',
		'company_id' => '1',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Timezone');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('timezones', $this->editedArray);
    }
