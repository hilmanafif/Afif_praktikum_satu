...
class EmploymentstatusServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(EmploymentstatusService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => 'laravel',
		'company_id' => '1',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Employmentstatus');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('employmentstatuses', $this->editedArray);
    }
