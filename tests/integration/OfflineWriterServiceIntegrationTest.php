...
class OfflineWriterServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(OfflineWriterService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => 'laravel',
		'description' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\OfflineWriter');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('offlinewriters', $this->editedArray);
    }
