...
class BankAccountServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(BankAccountService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => 'laravel',
		'address' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\BankAccount');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('bankaccounts', $this->editedArray);
    }
