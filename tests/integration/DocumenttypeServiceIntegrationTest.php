...
class DocumenttypeServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(DocumenttypeService::class);
        $this->originalArray = [
            'id' => '1',
		'name' => 'laravel',
		'company_id' => '1',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Documenttype');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('documenttypes', $this->editedArray);
    }
