...
class AgamaServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(AgamaService::class);
        $this->originalArray = [
            'id' => '1',
		'kode' => 'laravel',
		'name' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Agama');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('agamas', $this->editedArray);
    }
