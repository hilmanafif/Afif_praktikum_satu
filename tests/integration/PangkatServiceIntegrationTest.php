...
class PangkatServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(PangkatService::class);
        $this->originalArray = [
            'id' => '1',
		'kodepangkat' => 'laravel',
		'name' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Pangkat');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('pangkats', $this->editedArray);
    }
