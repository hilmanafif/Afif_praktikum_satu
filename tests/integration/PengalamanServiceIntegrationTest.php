...
class PengalamanServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(PengalamanService::class);
        $this->originalArray = [
            'id' => '1',
		'instansi' => 'laravel',
		'jabatan' => 'laravel',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Pengalaman');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('pengalamen', $this->editedArray);
    }
