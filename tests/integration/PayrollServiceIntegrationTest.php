...
class PayrollServiceIntegrationTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(PayrollService::class);
        $this->originalArray = [
            'id' => '1',
		'title' => 'laravel',
		'user_id' => '1',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Payroll');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('payrolls', $this->editedArray);
    }
